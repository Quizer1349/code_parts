...
//  PosingGuide
//
//  Created by Алекс Скляр on 05.10.14.
...
#define ARCVIEW_DEFAULT_FONT_SIZE   13.0
#define ARCVIEW_DEFAULT_RADIUS      177.f
#define ARCVIEW_DEFAULT_ARC_SIZE    89.0



@implementation PGTextArcView2
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        if(IS_IPAD()){
            self.font = [UIFont fontWithName:ARCVIEW_DEFAULT_FONT_NAME size:26];
            self.text = @"Curvaceous Type";
            self.radius = 350.f;
            self.showsGlyphBounds = NO;
            self.showsLineMetrics = NO;
